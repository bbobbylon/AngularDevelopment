...
const QA_LIST: QA[] = [
  ...
  // ======================== MID ========================
  {
    ...
    followUp:
      'What happens if you mutate an array that was passed as an input to an OnPush component?',
  },
  {
    id: 10,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How would you pass a return URL to the login page so users can be redirected back after login?',
  },
  {
    id: 13,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How would you convert a cold HTTP Observable to hot so all subscribers share one request?',
  },
  {
    id: 48,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      "How do you style a child component's internals from a parent when ViewEncapsulation.Emulated is on?",
  },
  {
    id: 50,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How do you test an Observable that uses a real delay() operator without real waiting?',
  },
  {
    id: 56,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between a publishable and a buildable library in an Angular Nx workspace?',
  },
  {
    id: 58,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What does provideExperimentalZonelessChangeDetection() do differently from provideZoneChangeDetection()?',
  },
  ...
  },
  {
    ...
    followUp:
      "How do you style a child component's internals from a parent when using Emulated encapsulation?",
  },
  {
    id: 65,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      "What happens to the async pipe's subscription when the component is inside an *ngIf that becomes false?",
  },
  {
    id: 70,
    level: 'senior',
  ...
  // ─── SIGNALS 76-90 ───────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'How do you convert an existing BehaviorSubject to a signal in incremental migration?',
  },
  {
    id: 77,
    level: 'junior',
  ...
  },
  {
    ...
    followUp:
      "What is the wire syntax difference between input() and model() from the parent's perspective?",
  },
  {
    id: 80,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How would you implement a "page resets to 1 when the filter changes" UX with linkedSignal()?',
  },
  {
    id: 83,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'How would you add a loading indicator that shows while the HTTP request is in flight?',
  },
  {
    id: 99,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between throttleTime with leading:true,trailing:false vs leading:false,trailing:true?',
  },
  {
    id: 104,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      "What CSS classes does Angular add to a FormControl's host element to reflect its state?",
  },
  {
    id: 110,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'If a FormGroup has updateOn: "submit" but a child FormControl has updateOn: "change", which wins?',
  },
  {
    id: 116,
    level: 'senior',
    ...
    followUp:
      'How do you reset `form.dirty` after a successful save so the dirty check stays accurate?',
  },
  ...
  },
  {
    ...
    followUp:
      'How do you show a global loading bar that appears during navigation and hides on NavigationEnd?',
  },
  {
    id: 124,
    level: 'mid',
    ...
    followUp:
      'How do you make a breadcrumb dynamically reflect the resolved product name instead of a static "Product Detail" string?',
  },
  {
    id: 125,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between debugElement.nativeElement and fixture.nativeElement?',
  },
  {
    id: 136,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the itemSize option on CdkVirtualScrollViewport and what happens if items have variable height?',
  },
  ...
  // ─── ARCHITECTURE 146-155 ─────────────────────────────────────────────────────
  {
    ...
    followUp:
      'When does the strict separation between smart and dumb components become counterproductive?',
  },
  {
    id: 147,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What happens when a child component provides a service that the parent also provides?',
  },
  {
    id: 150,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between T extends object and T extends Record<string, unknown>?',
  },
  {
    id: 158,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between inject() and constructor injection in terms of testability?',
  },
  {
    id: 161,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the isPlatformBrowser() utility and when do you need it alongside Renderer2?',
  },
  {
    id: 167,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'What is the trade-off between storing full state snapshots vs. storing action deltas for undo/redo?',
  },
  {
    id: 170,
    level: 'junior',
    ...
    followUp:
      'What TypeScript type does asReadonly() return and how does it differ from WritableSignal<T>?',
  },
  {
    id: 171,
    level: 'senior',
    ...
    followUp:
      'What timing guarantees does toObservable() give — does the Observable emit synchronously when the signal changes?',
  },
  ...
  // ─── RXJS 172-175 ─────────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'What is the difference between a pipeable (lettable) operator and a creation operator like interval()?',
  },
  {
    id: 173,
    level: 'mid',
    ...
    followUp:
      'How do you add a maximum total timeout across all retry attempts, not just per attempt?',
  },
  {
    id: 174,
    level: 'senior',
    ...
    followUp:
      'How does webSocket() handle reconnection — does it restore subscriptions from before the disconnect?',
  },
  {
    id: 175,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How do you pass Angular environment values into an SSR server without hardcoding them?',
  },
  {
    id: 178,
    level: 'senior',
    ...
    followUp:
      'How do you validate the shape of the loaded config.json at runtime to catch misconfiguration early?',
  },
  {
    id: 179,
    level: 'junior',
  ...
  // ─── TESTING 180-182 ─────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'What is HarnessLoader and how does it help test a parent component that contains multiple harness instances?',
  },
  {
    id: 181,
    level: 'mid',
    ...
    followUp:
      'How do you test that a CanDeactivate guard shows a confirmation dialog before leaving a route?',
  },
  {
    id: 182,
    level: 'senior',
    ...
    followUp:
      'What is the trade-off between data-testid attributes and ARIA-role selectors for Playwright tests?',
  },
  ...
  // ─── PERFORMANCE 183-185 ─────────────────────────────────────────────────────
  {
    ...
    followUp:
      'Does preloading happen for nested lazy child routes automatically, or do you need to configure it separately?',
  },
  {
    id: 184,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How do you handle a Webpack-specific plugin (e.g., a custom SVG loader) when migrating to the esbuild builder?',
  },
  ...
  },
  {
    ...
    followUp:
      'How would you use template literal types to type a strongly-typed i18n translation function?',
  },
  {
    id: 188,
    level: 'mid',
  ...
  // ─── ROUTING 190-191 ─────────────────────────────────────────────────────────
  {
    ...
    followUp:
      "How does Angular's TitleStrategy interact with SSR and what does it set on the server?",
  },
  {
    id: 191,
    level: 'senior',
    ...
    followUp:
      'How do you skip route animations for users who prefer reduced motion (prefers-reduced-motion)?',
  },
  ...
  // ─── FORMS 192-193 ──────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'How do you make the confirm-password field show ng-invalid CSS state when the group-level error fires?',
  },
  {
    id: 193,
    level: 'mid',
    ...
    followUp:
      'Why does form.value exclude disabled controls, and when does that cause subtle bugs?',
  },
  ...
  },
  {
    ...
    followUp:
      'What is the difference between ComponentRef.destroy() and ViewContainerRef.detach() for dynamic components?',
  },
  {
    id: 197,
    level: 'mid',
    ...
    followUp:
      'Can you still implement ngOnChanges on a component that uses the input() signal API?',
  },
  ...
  },
  {
    ...
    followUp:
      'How do you add a maximum polling duration (e.g., time out after 2 minutes regardless of job status)?',
  },
  ...
  // ─── ARCHITECTURE 205-208 ─────────────────────────────────────────────────────
  {
    ...
    followUp:
      'Are there legitimate cases where imperative code is the right choice in Angular even in 2025?',
  },
  {
    id: 206,
    level: 'mid',
    ...
    followUp:
      'What is the difference between useValue, useClass, useFactory, and useExisting in provider definitions?',
  },
  {
    id: 207,
    level: 'senior',
    ...
    followUp:
      'How do you handle SSR in a multi-tenant app where tenant identity comes from the request hostname?',
  },
  {
    id: 208,
    level: 'junior',
    ...
    followUp:
      'How do you provide a root-level singleton service in a standalone app that has no AppModule?',
  },
  ...
  },
  {
    ...
    followUp:
      'Which of the four coverage metrics (statements, branches, functions, lines) is the most meaningful and why?',
  },
  {
    id: 211,
    level: 'senior',
  ...
  },
  {
    ...
    followUp:
      'How do Angular CDK harnesses differ from hand-rolled page objects in terms of API stability guarantees?',
  },
  ...
  // ─── PERFORMANCE 213-215 ─────────────────────────────────────────────────────
  {
    ...
    followUp:
      'What happens if the NGSW has cached a broken version — how do you force all clients to update?',
  },
  {
    id: 214,
    level: 'mid',
    ...
    followUp:
      'How do you prevent TransferState from caching authenticated user-specific responses on the server?',
  },
  {
    id: 215,
    level: 'senior',
    ...
    followUp:
      'How do you provide route parameters to the prerenderer for parameterised routes like /product/:id?',
  },
  ...
  },
  {
    ...
    followUp:
      'What is the difference between Object.freeze() and as const — do they provide the same guarantees?',
  },
  {
    id: 218,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'What is the difference between readonly on a class property and const on a variable — can you reassign either?',
  },
  ...
  // ─── ROUTING 220-222 ─────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'How do you read the state object from NavigationExtras in the destination component after navigation completes?',
  },
  {
    id: 221,
    level: 'junior',
    ...
    followUp:
      'How do you set the HTTP 404 status code for the wildcard route when Angular SSR is active?',
  },
  {
    id: 222,
    level: 'senior',
    ...
    followUp:
      'How do you access a grandparent route\'s resolved data from a grandchild component without enabling "always" inheritance?',
  },
  ...
  // ─── FORMS 223 ──────────────────────────────────────────────────────────────
  {
    ...
    followUp:
      'Can you nest FormRecord inside a FormGroup to model a complex dynamic form hierarchy?',
  },
  ...
  // COMPONENTS
  {
    ...
    followUp:
      "How do you forward an input from a hostDirective to the host component's public API?",
  },
  {
    id: 225,
    level: 'mid',
    ...
    followUp:
      'How would you create a generic data table component where the consumer provides the row template?',
  },
  {
    id: 226,
    level: 'junior',
    ...
    followUp:
      "What is the difference between a service provided in root vs one provided in a component's providers array?",
  },
  {
    id: 227,
    level: 'senior',
    ...
    followUp:
      'Why does the Angular docs say "effects are rarely the best tool" for deriving state?',
  },
  {
    id: 228,
    level: 'mid',
  ...
  },
  {
    ...
    followUp:
      'How would you write a custom validator that checks if a value matches a specific pattern?',
  },
  {
    id: 230,
    level: 'junior',
  ...
  },
  {
    ...
    followUp:
      'How does standalone components architecture improve upon the pre-Ivy NgModule model for bundle size?',
  },
  {
    id: 232,
    level: 'mid',
    ...
    followUp:
      'How would you decide when to write an integration test vs a unit test for an Angular service?',
  },
  {
    id: 233,
    level: 'mid',
    ...
    followUp:
      'How do signals change the tradeoffs of this pattern compared to RxJS-based state management?',
  },
  ...
  // SIGNALS
  {
    ...
    followUp:
      'What happens if a signal is read conditionally in a template — does Angular track it even in the false branch?',
  },
  {
    id: 235,
    level: 'mid',
    ...
    followUp:
      'Can you use model() with two-way binding syntax even if the parent does not need two-way binding?',
  },
  {
    id: 236,
    level: 'junior',
    ...
    followUp:
      'What function can you use to explicitly opt out of tracking inside a reactive context?',
  },
  ...
  },
  {
    ...
    followUp:
      'How would you write a marble test for a search observable that uses debounceTime(300)?',
  },
  {
    id: 239,
    level: 'junior',
    ...
    followUp:
      'What is the alternative takeUntil pattern and why did Angular introduce takeUntilDestroyed instead?',
  },
  ...
  // FORMS
  {
    ...
    followUp:
      'What is the difference between ControlValueAccessor and a custom form field that uses existing controls internally?',
  },
  {
    id: 241,
    level: 'mid',
  ...
  // ROUTING
  {
    ...
    followUp:
      'What are the risks of reusing components across navigations with RouteReuseStrategy?',
  },
  {
    id: 244,
    level: 'mid',
    ...
    followUp:
      'How do you read resolved data from a route resolver with withComponentInputBinding()?',
  },
  {
    id: 245,
    level: 'junior',
    ...
    followUp:
      'Can you have both canMatch and canActivate on the same route, and what order do they run in?',
  },
  ...
  },
  {
    ...
    followUp:
      'How would you structure a test suite to ensure complete isolation when testing a service that uses localStorage?',
  },
  {
    id: 248,
    level: 'junior',
  ...
  // PERFORMANCE
  {
    ...
    followUp:
      'What is client-side hydration and what can go wrong if the SSR HTML does not match the client render?',
  },
  {
    id: 250,
    level: 'senior',
    ...
    followUp:
      'How does incremental hydration relate to the @defer directive and what triggers does it support?',
  },
  ...
  },
  {
    ...
    followUp:
      'How would you write a mapped type that makes all properties of T into readonly signals?',
  },
  {
    id: 253,
    level: 'junior',
    ...
    followUp:
      'What is TypeScript declaration merging and when would you use it in an Angular library?',
  },
];
...
export class Interview {
  ...
  drillReview() {
    ...
    this.flashQueue()
      .filter((q) => r.get(q.id) === 'review')
      .forEach((q) => r.delete(q.id));
    this.ratings.set(r);
    this.resetSession();
  }
